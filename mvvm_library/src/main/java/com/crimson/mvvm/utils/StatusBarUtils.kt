...
object StatusBarUtils {
    ...
    private const val FAKE_STATUS_BAR_VIEW = "fake_status_bar_view"
    private const val FAKE_TRANSLUCENT_VIEW = "fake_translucent_view"
    ...
    fun setColor(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            val fakeStatusBarView =
                decorView.findViewWithTag<View>(FAKE_STATUS_BAR_VIEW)
    ...
    fun setColorDiff(activity: Activity, @ColorInt color: Int) {
        ...
        // 移除半透明矩形,以免叠加
        val fakeStatusBarView =
            contentView.findViewWithTag<View>(FAKE_STATUS_BAR_VIEW)
        if (fakeStatusBarView != null) {
            if (fakeStatusBarView.visibility == View.GONE) {
                fakeStatusBarView.visibility = View.VISIBLE
            }
...
// 添加 statusBarView 到布局中
        ...
        val fakeStatusBarView =
            contentLayout.findViewWithTag<View>(FAKE_STATUS_BAR_VIEW)
        if (fakeStatusBarView != null) {
            if (fakeStatusBarView.visibility == View.GONE) {
                fakeStatusBarView.visibility = View.VISIBLE
            }
    ...
    fun hideFakeStatusBarView(activity: Activity) {
        ...
        val fakeTranslucentView =
            decorView.findViewWithTag<View>(FAKE_TRANSLUCENT_VIEW)
    ...
    private fun addTranslucentView(
        ...
        val contentView =
            activity.findViewById<View>(R.id.content) as ViewGroup
        val fakeTranslucentView =
            contentView.findViewWithTag<View>(FAKE_TRANSLUCENT_VIEW)
        if (fakeTranslucentView != null) {
    ...
    private fun createStatusBarView(
        ...
        statusBarView.tag = FAKE_STATUS_BAR_VIEW
    ...
    private fun createTranslucentStatusBarView(
        ...
        statusBarView.tag = FAKE_TRANSLUCENT_VIEW
        return statusBarView
    }
