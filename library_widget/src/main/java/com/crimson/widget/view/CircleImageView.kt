package com.crimson.widget.view
...
class CircleImageView @JvmOverloads constructor(
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        setBackgroundColor(attributes.getColor(R.styleable.CircleImageView_civ_background_color, Color.WHITE))

        // Init Shadow
        if (attributes.getBoolean(R.styleable.CircleImageView_civ_shadow, false)) {
            shadowRadius = DEFAULT_SHADOW_RADIUS
            drawShadow(
                attributes.getFloat(R.styleable.CircleImageView_civ_shadow_radius, shadowRadius),
                attributes.getColor(R.styleable.CircleImageView_civ_shadow_color, shadowColor)
            )
            val shadowGravityIntValue =
                attributes.getInteger(
                    R.styleable.CircleImageView_civ_shadow_gravity,
